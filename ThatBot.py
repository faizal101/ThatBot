...
strings = [', but instead slipped on some jam and fell right into the placed hole.',
...
@bot.command()
async def info(ctx):
    emb = (discord.Embed(title='Online', description='A bot made for fun by Kuuhaku#4503', colour=0xEC40DF))
...
async def commands(ctx):
    emb = (discord.Embed(title="List of commands: ", description=
        ...
        '\n.info –Shows information about the bot \n.invite –invite link to add this bot to your server if you want I guess '
